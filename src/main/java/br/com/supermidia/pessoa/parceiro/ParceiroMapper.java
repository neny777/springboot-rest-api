...
public interface ParceiroMapper {
	...
	// Parceiro -> ParceiroFisicoDTO
	@Mapping(source = "parceiro.id", target = "id")
	...
	ParceiroFisicoDTO toParceiroFisicoDTO(Fisica fisica, Parceiro parceiro);

	// Parceiro -> ParceiroJuridicoDTO
	@Mapping(source = "parceiro.id", target = "id")
	...
	ParceiroJuridicoDTO toParceiroJuridicoDTO(Juridica juridica, Parceiro parceiro);

	@Mapping(target = "id", ignore = true)
	@Mapping(target = "pessoa", expression = "java(updatePessoaFisica(parceiroFisicoDTO, parceiro.getPessoa()))")
	void updateParceiroFisicoFromDTO(ParceiroFisicoDTO parceiroFisicoDTO, @MappingTarget Parceiro parceiro);
	
	@Mapping(target = "id", ignore = true)
	@Mapping(target = "pessoa", expression = "java(updatePessoaJuridica(parceiroJuridicoDTO, parceiro.getPessoa()))")
	void updateParceiroJuridicoFromDTO(ParceiroJuridicoDTO parceiroJuridicoDTO, @MappingTarget Parceiro parceiro);
	...
	void updateFisicaFromDTO(ParceiroFisicoDTO parceiroFisicoDTO, @MappingTarget Fisica fisica);
	...
	@Mapping(target = "municipio", source = "municipio")
	@Mapping(target = "uf", source = "uf")
	void updateJuridicaFromDTO(ParceiroJuridicoDTO parceiroJuridicoDTO, @MappingTarget Juridica juridica);

	@Mapping(target = "id", source = "id")
	@Mapping(target = "pessoa", expression = "java(toFisica(parceiroFisicoDTO))")
	Parceiro toParceiroFisico(ParceiroFisicoDTO parceiroFisicoDTO);
	
	@Mapping(target = "id", source = "id")
	@Mapping(target = "pessoa", expression = "java(toJuridica(parceiroJuridicoDTO))")
	Parceiro toParceiroJuridico(ParceiroJuridicoDTO parceiroJuridicoDTO);
	...
	@Mapping(target = "municipio", source = "municipio")
	@Mapping(target = "uf", source = "uf")
	Fisica toFisica(ParceiroFisicoDTO parceiroFisicoDTO);
	...
	@Mapping(target = "municipio", source = "municipio")
	@Mapping(target = "uf", source = "uf")
	Juridica toJuridica(ParceiroJuridicoDTO parceiroJuridicoDTO);

	default Pessoa updatePessoaFisica(ParceiroFisicoDTO parceiroFisicoDTO, Pessoa pessoa) {
		if (pessoa instanceof Fisica fisica) {
			updateFisicaFromDTO(parceiroFisicoDTO, fisica);
		} else {
	...
	default Pessoa updatePessoaJuridica(ParceiroJuridicoDTO parceiroJuridicoDTO, Pessoa pessoa) {
		if (pessoa instanceof Juridica juridica) {
			updateJuridicaFromDTO(parceiroJuridicoDTO, juridica);
		} else {
			throw new IllegalStateException("A pessoa associada não é do tipo Fisica.");
		}
		return pessoa;
